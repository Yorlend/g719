...
#ifndef _COUNT_H
#define _COUNT_H "$Id: count.h,v 1.2 2007/11/29 18:09:11 egusull Exp $"
...
#define FRAME_RATE	(0.00005F) /*in this version frame_rate can be overwriten online by the new setFrameRate function */
